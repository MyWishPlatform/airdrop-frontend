import {SOLANA_AIRDROP_ABI, SOLANA_AIRDROP_ADDRESSES} from '../../constants/contracts/solana-airdrop';
...
export class AirdropContract extends AbstractContract {
  constructor(
    ...
    super(phantom, SOLANA_AIRDROP_ABI, airdropAddress);
  }


  public async getFee(): Promise<any> {
    return this.contract.getFees().call();
  }
